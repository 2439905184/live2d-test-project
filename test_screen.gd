...
#var file_name:String = 'rena.model3.json'
...
func _ready() -> void:
	...
	#文件名入口
	var res_path: String = "res://Haru/"
	var file_name:String = 'Haru.model3.json'
	print(res_path)
	print(file_name)
	...
	#model = factory.cubism_loader("res://rena/rena.model3.json")
	canvas_info = CubismFactory.canvas_info(model.canvas_info())
	print(factory)
	#print(factory.get_method_list())
	var json = model.json()
